...
if($error){
    ...
    $sql="INSERT INTO patient_signup(name,age,addr,email,phone,password,vkey,verified) values('$name','$age','$addr','$email','$phone','$password','$vkey', 0)";
    if(!mysqli_query($conn,$sql))
    {
        ...
        // $message="Hi, $name. Thank you for registering with us!Please click on the link below to verify your account:<br><a href='https://localhost/forms_doctor_patient-20200727T153730Z-001/forms_doctor_patient/verify.php?vkey=$vkey'>Regiter Now!</a>";
        // $message = "Thank you for registering";
        $message="Hi, $name. Thank you for registering with us!Please click on the link below to verify your account:<br><a href='http://localhost/efficient_Doc_Patient-master/verify.php?vkey=$vkey'>Regiter Now!</a>";
